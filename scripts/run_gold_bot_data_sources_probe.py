...
def parse_args(argv=None):
    ...
    p.add_argument("--history-dir", default=None, dest="history_dir",
                   help="MT5 history dir (default data/gold_bot/history).")
    p.add_argument("--macro-history-dir", default=None, dest="macro_history_dir",
                   help="Macro history dir (default data/gold_bot/macro_history).")
...
def main(argv=None) -> int:
    ...
    statuses = build_data_source_overview(
        ...
        history_dir=args.history_dir, macro_history_dir=args.macro_history_dir, now=now)
